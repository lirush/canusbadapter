...
static uint8_t Usb_CDC_String_Descriptor[4]=
{
			0x04,                              /* bLength */
...
static uint8_t Usb_CDC_String_Descriptor_iM[18]=
{
...
static uint8_t Usb_CDC_String_Descriptor_iP[18]=
{
...
static uint8_t Usb_CDC_String_Descriptor_SN[26]=
{
...
//static uint8_t Usb_CDC_String_Descriptor[90]=
//{
//			0x04,                              /* bLength */
//			0x03,											        /* bDescriptorType */
//			0x09,0x04, 												/* US English */    /* wLANGID */
      ...
      case USB_CONFIGURATION:
        ...
        break;
			case USB_STRING:
				...
				{
					case 0:
						pDescr = Usb_CDC_String_Descriptor;
						length = 0x04;						
						break;
					case 1:
						pDescr = Usb_CDC_String_Descriptor_iM;
						length = 0x12;						
						break;
					case 2:
						pDescr = Usb_CDC_String_Descriptor_iP;
						length = 0x12;							
						break;	
					case 3:
						pDescr = Usb_CDC_String_Descriptor_SN;
						length = 0x1A;							
						break;
				}
			break;
...
static USB_Result USB_CDC_OnDataReceive(USB_EP_TypeDef EPx, uint8_t* Buffer, uint32_t Length)
{
  ...
  if (USB_CDCContext.CDC_ReceiveDataStatus == USB_SUCCESS)
  {
		USB_EP_SetNewDataOut(USB_CDC_EP_RECEIVE);
    return USB_EP_doDataOut(USB_CDC_EP_RECEIVE, USB_CDCContext.CDC_ReceiveBuffer,
              USB_CDCContext.CDC_DataPortionLength, USB_CDC_OnDataReceive);
  }
  else
...
uint8_t USB_CDC_NewDataReceive(void)
{
	return USB_EP_GetFlNewDataOut(USB_CDC_EP_RECEIVE);
}

void USB_CDC_ClearNewDataReceive(void)
{
	USB_EP_ClearFlNewDataOut(USB_CDC_EP_RECEIVE);
}
